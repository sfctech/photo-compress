...
class CompressImage(ProcessBase):
    ...
    def processfile(self, filename):
        ...
        try:
            ...
            print(filename + '\t\tratio: ' + str(round(newsize/float(origsize)*100, 2)) + '%')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--resize', dest='baseWidth', type=int, default=0,
        help='Resize image based on width providing')
    parser.add_argument(
    ...
    # check baseWidth is set in arguments
    if args.baseWidth == 0:
        basewidth = 1920
    else:
    ...
    if args.mode == modecompress:
        processor = CompressImage(basewidth)
